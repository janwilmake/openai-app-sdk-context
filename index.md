...
[### App design guidelines Design components and conversational flows that feel native to ChatGPT. Explore design guidelines](https://developers.openai.com/apps-sdk/concepts/design-guidelines)[### App developer guidelines Build apps that meet our quality, safety, and policy standards. Review developer guidelines](https://developers.openai.com/apps-sdk/app-developer-guidelines)

Get started
-----------

[Plan ### Research use cases Identify and prioritize Apps SDK use cases. Dive in](https://developers.openai.com/apps-sdk/plan/use-case)[Build ### Set up your server Create and configure an MCP server. Dive in](https://developers.openai.com/apps-sdk/build/mcp-server)[Deploy ### Deploy your app Learn how to deploy your MCP server Dive in](https://developers.openai.com/apps-sdk/deploy)

Guides
------

[![Image 2: Optimize Metadata](https://developers.openai.com/images/apps-sdk/ecosystem-bg1.png) #### Optimize Metadata Improve discovery and behavior with rich metadata.](https://developers.openai.com/apps-sdk/guides/optimize-metadata)[![Image 3: Security & Privacy](https://developers.openai.com/images/apps-sdk/ecosystem-bg2.png) #### Security & Privacy Security and privacy considerations for Apps SDK.](https://developers.openai.com/apps-sdk/guides/security-privacy)[![Image 4: Troubleshooting](https://developers.openai.com/images/apps-sdk/ecosystem-bg3.png) #### Troubleshooting Troubleshoot issues in Apps SDK apps.](https://developers.openai.com/apps-sdk/deploy/troubleshooting)
