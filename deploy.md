...
URL Source: https://developers.openai.com/apps-sdk/deploy
...
*   [Deployment options](https://developers.openai.com/apps-sdk/deploy#deployment-options)
*   [Local development](https://developers.openai.com/apps-sdk/deploy#local-development)
*   [Environment configuration](https://developers.openai.com/apps-sdk/deploy#environment-configuration)
*   [Dogfood and rollout](https://developers.openai.com/apps-sdk/deploy#dogfood-and-rollout)
*   [Next steps](https://developers.openai.com/apps-sdk/deploy#next-steps)
...
[Next Connect from ChatGPT](https://developers.openai.com/apps-sdk/deploy/connect-chatgpt)
